...
module.exports = function (environment) {
  let ENV = {
    ...
    urls: {
      ...
      docsDocker: 'https://docs.travis-ci.com/user/docker/',
      docsNode: 'https://docs.travis-ci.com/user/languages/javascript-with-nodejs/',
      docsMultiOS: 'https://docs.travis-ci.com/user/multi-os/',
      docsNoRun: 'https://docs.travis-ci.com/user/common-build-problems/#i-pushed-a-commit-and-cant-fin',
