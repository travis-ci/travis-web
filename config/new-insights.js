...
const NEW_INSIGHTS_PRIVATE_KEY_LABELS = {
  'aws': ['Private Key', 'This is the private key of Plugin', 'Enter Your AWS Private Key'],
  'sre': ['Private Key', 'This is the private key of Plugin', 'Enter Your Travis Insights Private Key'],
  'cloudwatch': ['Private Key', 'This is the private key of Plugin', 'Enter Your AWS CloudWatch Private Key'],
  'datadog': ['Application Key', 'This is the application key of Plugin', 'Enter Your Datadog Application Key'],
  'github': ['Personal Access Token', 'This is the personal access token of Plugin', 'Enter Your GitHub Personal Access Token'],
  'bamboo': ['Password', 'This is the password of Plugin', 'Enter Your Bamboo CI Password'],
  'appdynamics': ['API token', 'This is the API token of Plugin', 'Enter Your AppDynamics API token'],
  'cloudbees': ['API token', 'This is the API token of Plugin', 'Enter Your Cloudbees API token'],
  'zendesk': ['API token', 'This is the API token of Plugin', 'Enter Your Zendesk API token'],
  'pingdom': ['API token', 'This is the API token of Plugin', 'Enter Your Pingdom API token'],
  'gcp': ['Service account private key', 'This is the private key of Plugin', 'Paste the contents of the JSON key downloaded from Google Console'],
  'gcs': ['Service account private key', 'This is the private key of Plugin', 'Paste the contents of the JSON key downloaded from Google Console'],
  'gitlab': ['Personal Access Token', 'This is the personal access token of Plugin', 'Enter Your Personal Access Token'],
  'sonarqube': ['Personal Access Token', 'This is the personal access token of Plugin', 'Enter Your Personal Access Token'],
  'buddyci': ['Personal Access Token', 'This is the personal access token of Plugin', 'Enter Your Personal Access Token'],
  'godaddy': ['API secret', 'This is the API secret of Plugin', 'Enter Your GoDaddy API secret'],
  'bitbucket': ['App Password', 'This is the app password of Plugin', 'Enter Your Bitbucket App Password'],
  'assembla': ['API secret', 'This is the API secret of Plugin', 'Enter Your Assembla API secret'],
  'dyn': ['Password', 'This is the password of Plugin', 'Enter Your Dyn Password'],
  'heroku': ['API Token', 'This is the API token of Plugin', 'Enter Your Heroku API Token'],
  'azure_devops': ['Personal Access Token', 'This is the personal access token of Plugin', 'Enter Your Azure Devops Personal Access Token'],
  'application_insights': ['API key', 'This is the API key of Plugin', 'Enter Your Azure Application Insights API key'],
  'newrelic': ['API key', 'This is the API key of Plugin', 'Enter Your NewRelic API Key'],
  'okta': ['API key', 'This is the API token of Plugin', 'Enter Your Okta API Key'],
  'pagerduty': ['API key', 'This is the API token of Plugin', 'Enter Your PagerDuty API Key'],
  'rollbar': ['Access Token', 'This is the access token of Plugin', 'Enter Your Rollbar Access Token'],
  'sentry': ['Auth Token', 'This is the auth token of Plugin', 'Enter Your Sentry Auth Token'],
  'onelogin': ['API Secret', 'This is the API secret of Plugin', 'Enter Your OneLogin API secret'],
  'azure': ['Password', 'This is the password of Plugin', 'Enter Your Azure Service Principal Password'],
  'sysdig': ['API Token', 'This is the API token of Plugin', 'Enter Your Sysdig API Token'],
  'teamcity': ['API Token', 'This is the API token of Plugin', 'Enter Your Teamcity API Token'],
  'travisci': ['API Token', 'This is the API token of Plugin', 'Enter Your Travis CI API Token'],
};
