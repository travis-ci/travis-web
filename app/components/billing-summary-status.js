...
export default Component.extend({
  ...
  isDefaultEducationView: computed('subscription', 'account.education', 'subscription.plan_name', function() {
    return this.get('subscription') && this.get('account.education') && this.get('subscription.plan_name') === 'Github Student developer pack 1 concurrent plan' && this.get('subscription').isNotEmpty;
  })
});
