...
export default Component.extend({
  ...
  cancelSubscription: task(function* () {
    try {
      ...
      this.flashes.successWithClose('Your cancellation request has been forwarded to Support. Our Support team will contact you soon.', "We’re sorry to see you go");
