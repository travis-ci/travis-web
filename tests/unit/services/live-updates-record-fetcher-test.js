...
//     let service = this.owner.factoryFor('service:live-updates-record-fetcher').create({ interval: 5 }),
...
//     let service = this.owner.factoryFor('service:live-updates-record-fetcher').create({ interval: 20 }),
//       store = service.get('store'),
//       done  = assert.async(),
//       findRecordSpy = sinon.spy(store, 'findRecord'),
//       queryRecordSpy = sinon.spy(store, 'queryRecord');
