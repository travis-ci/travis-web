...
test('view settings', function(assert) {
  ...
  andThen(function() {
    ...
    assert.ok(settingsPage.crons(0).enqueuingInterval.indexOf('Every day at') === 0, 'Shows daily enqueuing text');
    ...
    assert.ok(settingsPage.crons(1).enqueuingInterval.indexOf('Every') === 0, 'Shows weekly enqueuing text');
