...
module('Acceptance | repo allowance', function (hooks) {
  ...
  test('warning is displayed in case owner cannot build in public repository', async function (assert) {
    ...
    assert.equal(page.flash, 'Builds have been temporarily disabled for public repositories due to a negative credit balance. Please go to the Plan page to replenish your credit balance or alter your Consume paid credits for OSS setting.');
  });
