...
module('Acceptance | profile/billing', function (hooks) {
  ...
  hooks.beforeEach(function () {
    ...
    this.server.create('v2-plan-config', {
      ...
      isFree: true, isUnlimitedUsers: true, addonConfigs: [{ type: 'credit_private' }, { type: 'credit_public'}],
      hasCreditAddons: true, hasOSSCreditAddons: true
    });
    this.server.create('v2-plan-config', {
      ...
      isFree: false, isUnlimitedUsers: false, addonConfigs: [{ type: 'credit_private' }, { type: 'credit_public'}],
      hasCreditAddons: true, hasOSSCreditAddons: true
    });
