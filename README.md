...
For special cases where the “is from” or “lives in” sentence forms don’t make sense, such as “ukswitzerland”, you can override the output in `app/components/team-member.js`.
